...
export function createInspDetailWordTemplate() {
  _seq = 0;
  ...
  const blocks = [
    ...
    {
      id: uid('tbl'), type: 'table', rows: 12, cols: 5,
    ...
    // 4. 주요 비정상 현황
    { id: uid('t'), type: 'text', subtype: 'h2', html: '4. 주요 비정상 현황' },

    // 4-1. 파일시스템
    { id: uid('t'), type: 'text', subtype: 'h3', html: '4-1. 파일시스템 사용량 (전체 비정상)' },
    ...
    { id: uid('t'), type: 'text', subtype: 'h3', html: '4-2. 메모리 사용률 초과 (7건)' },
    {
      ...
      cells: {
        '0,0': '시스템', '0,1': '점검항목', '0,2': '결과', '0,3': '요약', '0,4': '상세 메시지',
        '1,0': 'icenshis01', '1,1': '메모리 사용률 점검', '1,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '1,3': '메모리 사용률 높음', '1,4': '현재: 87.0%',
        '2,0': 'icensele01', '2,1': '메모리 사용률 점검', '2,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '2,3': '메모리 사용률 높음', '2,4': '현재: 80.3%',
        '3,0': 'icenspos01', '3,1': '메모리 사용률 점검', '3,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '3,3': '메모리 사용률 높음', '3,4': '현재: 80.7%',
        '4,0': 'icenssmc01', '4,1': '메모리 사용률 점검', '4,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '4,3': '메모리 사용률 높음', '4,4': '현재: 84.8%',
        '5,0': 'icenseag01', '5,1': '메모리 사용률 점검', '5,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '5,3': '메모리 사용률 높음', '5,4': '현재: 81.9%',
        '6,0': 'icensbut01', '6,1': '메모리 사용률 점검', '6,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '6,3': '메모리 사용률 높음', '6,4': '현재: 82.8%',
        '7,0': 'icensns02',  '7,1': '메모리 사용률 점검', '7,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '7,3': '메모리 사용률 높음', '7,4': '현재: 86.8%',
      },
      cellBg: {},
    },
    ...
    { id: uid('t'), type: 'text', subtype: 'h3', html: '4-4. Disk I/O 이상 (8건)' },
    {
      ...
      cells: {
        '0,0': '시스템', '0,1': '점검항목', '0,2': '결과', '0,3': '요약', '0,4': '상세 메시지',
        '1,0': 'icensmis02', '1,1': 'Disk I/O 점검', '1,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '1,3': 'I/O Wait 높음', '1,4': 'iowait: 12.46%',
        '2,0': 'icensele01', '2,1': 'Disk I/O 점검', '2,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '2,3': 'I/O Wait 높음', '2,4': 'iowait: 10.6%',
        '3,0': 'icensels02', '3,1': 'Disk I/O 점검', '3,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '3,3': 'I/O Wait 높음', '3,4': 'iowait: 14.78%',
        '4,0': 'icensks01',  '4,1': 'Disk I/O 점검', '4,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '4,3': 'I/O Wait 높음', '4,4': 'iowait: 11.9%',
        '5,0': 'icensksc01', '5,1': 'Disk I/O 점검', '5,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '5,3': 'I/O Wait 높음', '5,4': 'iowait: 12.93%',
        '6,0': 'icensksc02', '6,1': 'Disk I/O 점검', '6,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '6,3': 'I/O Wait 높음', '6,4': 'iowait: 11.29%',
        '7,0': 'icensns02',  '7,1': 'Disk I/O 점검', '7,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '7,3': 'I/O Wait 높음', '7,4': 'iowait: 14.58%',
        '8,0': 'icensga01',  '8,1': 'Disk I/O 점검', '8,2': '<span style="color:#f59e0b;font-weight:600">비정상</span>', '8,3': 'I/O Wait 높음', '8,4': 'iowait: 13.07%',
      },
      cellBg: {},
    },
    ...
    { id: uid('t'), type: 'text', html: '점검 결과 확인된 비정상 및 실패 항목에 대해 다음과 같이 조치하였습니다. 파일시스템 전체 비정상 건은 디스크 용량 확보 작업을 일괄 진행 중이며, 로그 점검 실패 4건은 에이전트 패치로 즉시 해결하였습니다.' },
    ...
    { id: uid('t'), type: 'text', html: '금회 「서버 및 WEB 점검」 결과 전체 223건(32대 서버 × 11개 항목) 중 169건(75%)이 정상으로 확인되었습니다. 파일시스템 사용량이 32대 전체 서버에서 임계치를 초과하여 준수율이 크게 하락하였으며, 이는 최근 데이터 증가량 대비 스토리지 증설이 지연된 것이 주요 원인입니다. 실패 4건은 에이전트 패치로 즉시 해결하였고, 메모리·CPU·Disk I/O 비정상 건은 DBA팀과 협조하여 순차적으로 조치 중입니다. 파일시스템 용량 확보를 위한 디스크 증설 및 데이터 아카이빙 정책 수립이 시급합니다.' },
    { id: uid('d'), type: 'divider' },
